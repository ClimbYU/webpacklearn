...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"testB"}[chunkId]||chunkId) + ".js";
...
__webpack_require__.e/* require.ensure */(0).then((function(require) {
    __webpack_require__(2); //代码保证了拆分点被创建，而且 b.js 被 webpack 分开打包。
}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);  //会生成testB.js文件，但必须配置  chunkFilename:'[name].js'
